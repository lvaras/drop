...
class events {
	...
	public function register_post_type()
	{
		$args = array(
				...
				'has_archive' => true,
				'show_ui' => true,
				#'menu_icon' => get_template_directory_uri() . '/bonelli_custom/images/mostre-icon-small.png',
	...
	public function enqueue_script_and_styles () 
	{
		...
		wp_enqueue_script('admin_scripts', plugins_url('' , __FILE__) . '/admin_scripts.js' , array( "jquery_ui" , "jquery-timepicker" ) );
		wp_enqueue_style('sonar_admin_css', plugins_url('' , __FILE__) . '/admin_styles.css' );
